package com.myself.book.springboot.controller;
...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        mvc.perform(post(url)
                ...
                .with(csrf())       // ? test fail : 403 error 리턴되어 csrf token 생성하여 넘겨줌 (참고 https://jungguji.github.io/2020/06/09/Spring-Controller-Test%EC%8B%9C-CSRF-%EC%84%A4%EC%A0%95/)
